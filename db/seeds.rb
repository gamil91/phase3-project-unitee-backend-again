...
# item_names = ["Avocado", "Floral", "Taco", "Corgi", "Paw", "Coffee", "Tree", "Meow", "Cat", "Doggo", "Music", "Bike", "Rainbow", "Wave", "Code", "Headphone", "Donut", "Pineapple"]

# item_names.map { |item|
#     Item.create(name:item, price:12)
# }
## ----- avo ----->
# Image.create(image_url:"https://i.postimg.cc/FFwJTqj0/AVO1.png", color: "black", item_id:1)
# Image.create(image_url:"https://i.postimg.cc/t4jnjxvT/AVO2.png", color: "maroon", item_id: 1)
